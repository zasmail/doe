...
{var refer=document.referrer.replace(/https?\:\/\//,'').split('https://www.energy.gov/')[0].replace('www.','');if(oCONFIG.SUBDOMAIN_BASED)
...
if(oCONFIG.ENHANCED_LINK){window[window['GoogleAnalyticsObject']](oCONFIG.PUA_NAME+dpv+'.require','linkid','linkid.html');}
